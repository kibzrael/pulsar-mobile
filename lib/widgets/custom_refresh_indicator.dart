...
typedef MyRefreshCallback = Future<void> Function();
...
/// always scrollable and, therefore, can trigger the [MyRefreshIndicator].
///
...
class MyRefreshIndicator extends StatefulWidget {
  ...
  const MyRefreshIndicator({
    ...
    this.notificationPredicate = myScrollNotificationPredicate,
    this.semanticsLabel,
    this.semanticsValue,
  }) : super(key: key);
  ...
  final IndicatorBuilder childBuilder;
    ...
    if (indicatorAtTopNow != _isIndicatorAtTop) {
      ...
      if (_mode == _RefreshIndicatorMode.drag ||
        ...
        if (notification.metrics.extentBefore > 0.0) {
          ...
          _dragOffset = (_dragOffset ?? 0) - notification.scrollDelta!;
...
bool myScrollNotificationPredicate(ScrollNotification notification) {
  return true;
}
